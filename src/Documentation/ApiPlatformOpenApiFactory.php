 ...
 */
#[AsAlias('api_platform.openapi.factory')]
final class ApiPlatformOpenApiFactory implements OpenApiFactoryInterface
{
    ...
    public function __construct(private readonly ResourceNameCollectionFactoryInterface $resourceNameCollectionFactory, private readonly ResourceMetadataCollectionFactoryInterface $resourceMetadataFactory, private readonly PropertyNameCollectionFactoryInterface $propertyNameCollectionFactory, private readonly PropertyMetadataFactoryInterface $propertyMetadataFactory, private readonly SchemaFactoryInterface $jsonSchemaFactory, private readonly TypeFactoryInterface $jsonSchemaTypeFactory, #[Autowire('@api_platform.filter_locator')] ContainerInterface $filterLocator, private readonly array $formats = [], ?Options $openApiOptions = null, ?PaginationOptions $paginationOptions = null, private readonly ?RouterInterface $router = null)
    {
    ...
    private function collectPaths(ApiResource $resource, ResourceMetadataCollection $resourceMetadataCollection, Paths $paths, \ArrayObject $schemas, \ArrayObject $webhooks): void
    {
        ...
        foreach ($resource->getOperations() as $operationName => $operation) {
            ...
            if ($overrideResponses || !$existingResponses) {
                ...
                switch ($method) {
                    case 'GET':
                    case 'OPTIONS': // NO Response for OPTIONS
